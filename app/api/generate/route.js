...
import { NextResponse } from 'next/server'; // Nganggo cara anyar

// Baca Konci Rahasia dari Vercel
const ai = new GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY });

// Ganti export default ku fungsi POST
export async function POST(req) {
  try {
    const { niche, audience } = await req.json(); // Baca data JSON tina request
