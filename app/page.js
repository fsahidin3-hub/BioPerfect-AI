...
// Styles 
const inputStyle = { width: '100%', padding: '12px', boxSizing: 'border-box', border: '1px solid #ddd', borderRadius: '6px', fontSize: '1em', };
const buttonStyle = { backgroundColor: '#0070f3', color: 'white', padding: '12px 20px', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '1.1em', fontWeight: 'bold', width: '100%', transition: 'background-color 0.3s' };
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', textAlign: 'center', padding: '20px', backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
      ...
      <header style={{ paddingBottom: '30px' }}>
        <h1 style={{ fontSize: '2.5em', color: '#1a1a1a' }}>**BioPerfect AI**</h1>
        <h2 style={{ fontSize: '1.5em', color: '#333', marginTop: '-10px' }}>Craft the Perfect Instagram Bio in Seconds.</h2>
        <p style={{ color: '#555', maxWidth: '600px', margin: '10px auto' }}>**Micro-SaaS:** Leverage AI to generate an optimized, high-converting 150-character bio that captures your niche and drives traffic.</p>
      </header>
